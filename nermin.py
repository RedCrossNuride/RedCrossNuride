...
import base64
from mesajlar.mesaj import salam, necesen, sagol, getdim, geldim, hi, hara, ds, nazli, nv, sd, ny,ax, nrs, sev, gul1, gul2, brs, yuxu, haralisan, can, yas, nermin, ban
...
async def yeni_mesaj(event: events.NewMessage.Event):
    await event.reply(f"{random.choice(nv)}")
