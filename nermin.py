...
import base64
from mesajlar.mesaj import salam, necesen, sagol, getdim, geldim, am, hi, hara, ds, nazli, sd, sz, ny,ax, nrs, sev, gul1, gul2, brs, yuxu, haralisan, can, yas, nermin, ban
...
@Nermin.on(events.NewMessage(pattern='(?i)baci+'))
async def yeni_mesaj(event: events.NewMessage.Event):
    await event.reply(f"{random.choice(sz)}")
